                    ...
                    <form action="{{ route('admin/products/update', $products->id) }}" method="POST">
                       ...
                       <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="text" name="discount" class="form-control" placeholder="Product Discount" value="{{$products->discount}}">
                                @error('discount')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                       ...
                       <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="text" name="stock" class="form-control" placeholder="Product Stock" value="{{$products->stock}}">
                                @error('stock')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
